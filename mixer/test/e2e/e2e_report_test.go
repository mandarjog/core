...
import (
	...
	spyAdapter "istio.io/core/mixer/test/spyAdapter"
	e2eTmpl "istio.io/core/mixer/test/template"
	reportTmpl "istio.io/core/mixer/test/template/report"
	testEnv "istio.io/core/mixer/test/testenv"
)
